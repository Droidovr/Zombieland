...
public class AvailablePosition
{
  ...
  public Vector3 GetSpawnPosition(Vector3 originSpawnPoint, float spawnRadius, float agentRadius)
  {
    //switch() 
    Vector3 freePoint = FillMatrixWithFreePoints(originSpawnPoint, spawnRadius, agentRadius);
      
    //CreateCharacter(freePoint, Quaternion.identity);
